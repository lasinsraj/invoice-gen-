    ...
    <div className="invoice-preview max-w-4xl mx-auto bg-white shadow-lg p-4 md:p-8 rounded print-only font-light">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
        <div>
          ...
          {invoice.billFrom.email && <p className="text-gray-600 break-words">{invoice.billFrom.email}</p>}
        ...
        <div className="mt-6 md:mt-0">
          ...
          {invoice.billTo.email && <p className="text-gray-600 break-words">{invoice.billTo.email}</p>}
